...
const GameData = {
    ...
    recruits: [
        ...
        { id: 1016985, name: '阿里馬烏斯', nameEn: 'Alimahus', race: 'hyur', gender: 'M', job: 'rogue', img: 'HyurmAlimahus.jpg' },
        // 精靈族 Elezen
        ...
        // 拉拉菲爾族 Lalafell
        { id: 1016944, name: '奴奴魯帕·塔塔魯帕', nameEn: 'Nunulupa Tatalupa', race: 'lalafell', gender: 'M', job: 'thaumaturge', img: 'Nunulupa_Tatalupa.png' },
        { id: 1016945, name: '納納索米', nameEn: 'Nanasomi', race: 'lalafell', gender: 'M', job: 'archer', img: 'LalamNanasomi.jpg' },
        { id: 1016946, name: '莉莉芭', nameEn: 'Liliba', race: 'lalafell', gender: 'F', job: 'conjurer', img: 'LalafellfLiliba.png' },
        { id: 1016947, name: '薩薩修', nameEn: 'Sasashu', race: 'lalafell', gender: 'F', job: 'lancer', img: 'LalafSasashu.jpg' },
        { id: 1016948, name: '姆吉恩·珀拉吉恩', nameEn: 'Mujen Polajen', race: 'lalafell', gender: 'M', job: 'rogue', img: 'Ffxiv_01042017_153909.png' },
        { id: 1016949, name: '穆穆塔諾', nameEn: 'Mumutano', race: 'lalafell', gender: 'M', job: 'gladiator', img: 'LalamMumutano.jpg' },
        { id: 1016950, name: '特瓦瓦', nameEn: 'Tewawa', race: 'lalafell', gender: 'F', job: 'arcanist', img: 'LalafTewawa.jpg' },
        { id: 1016951, name: '托托蒂', nameEn: 'Totodi', race: 'lalafell', gender: 'F', job: 'pugilist', img: 'LalafTotodi.jpg' },
        { id: 1016952, name: '克魯莫莫', nameEn: 'Kelmomo', race: 'lalafell', gender: 'F', job: 'marauder', img: 'LalafKelmomo.png' },
        { id: 1016953, name: '塞塞力庫', nameEn: 'Seserikku', race: 'lalafell', gender: 'M', job: 'marauder', img: 'LalamSeserikku.jpg' },
        // 貓魅族 Miqo'te
        { id: 1016954, name: '碧·貝納·提亞', nameEn: "B'benha Tia", race: 'miqote', gender: 'M', job: 'lancer', img: 'MiqotemBbenha.jpg' },
        { id: 1016955, name: '玖茲·阿·嘉奇亞', nameEn: "Ziuz'a Jakkya", race: 'miqote', gender: 'M', job: 'rogue', img: 'MiqotemZiuza.jpg' },
        { id: 1016956, name: '維·恩波蘿', nameEn: "V'nbolo", race: 'miqote', gender: 'F', job: 'archer', img: 'MiqotefVnbolo.jpg' },
        { id: 1016957, name: '奧雅·奈爾赫', nameEn: 'Oah Nelhah', race: 'miqote', gender: 'F', job: 'pugilist', img: 'MiqotefOah.jpg' },
        { id: 1016958, name: '德·福爾·提亞', nameEn: "D'fhul Tia", race: 'miqote', gender: 'M', job: 'conjurer', img: 'MiqotemDfhul.jpg' },
        { id: 1016959, name: '格塔·阿·帕尼帕爾', nameEn: "Gota'a Panipahr", race: 'miqote', gender: 'M', job: 'thaumaturge', img: 'MiqotemGotaa.jpg' },
        { id: 1016960, name: '嘉·魯達巴', nameEn: "J'ludaba", race: 'miqote', gender: 'F', job: 'arcanist', img: 'MiqotefJludaba.jpg' },
        { id: 1016961, name: '伊恩·雅瑪里約', nameEn: 'Yehn Amariyo', race: 'miqote', gender: 'F', job: 'gladiator', img: 'MiqotefYehn.jpg' },
        { id: 1016962, name: '艾·派特爾密', nameEn: "E'ptolmi", race: 'miqote', gender: 'F', job: 'archer', img: 'MiqotefEptolmi.jpg' },
        { id: 1016963, name: '凱達·托·莫伊', nameEn: "Kehda'to Moui", race: 'miqote', gender: 'M', job: 'archer', img: 'MiqotemKehdato.jpg' },
        // 魯加族 Roegadyn
        { id: 1016964, name: '哈斯塔爾烏雅', nameEn: 'Hastaloeya', race: 'roegadyn', gender: 'M', job: 'marauder', img: 'RoegmHastaloeya.jpg' },
        { id: 1016965, name: '納因·戈特', nameEn: 'Gnawing Goat', race: 'roegadyn', gender: 'M', job: 'conjurer', img: 'RoegmGnawing.jpg' },
        { id: 1016966, name: '庫恩布瑞達', nameEn: 'Koenbryda', race: 'roegadyn', gender: 'F', job: 'gladiator', img: 'RoegfKoenbryda.jpg' },
        { id: 1016967, name: '科爾蕾絲·威斯帕', nameEn: 'Careless Whisper', race: 'roegadyn', gender: 'F', job: 'rogue', img: 'RoegfCareless.jpg' },
        { id: 1016968, name: '里爾哈厄', nameEn: 'Rhylharr', race: 'roegadyn', gender: 'M', job: 'pugilist', img: 'RoegmRhylharr.jpg' },
        { id: 1016969, name: '卡拉斯·斯泰德', nameEn: 'Callous Steed', race: 'roegadyn', gender: 'M', job: 'thaumaturge', img: 'RoegmCallous.jpg' },
        { id: 1016970, name: '因格希爾希斯', nameEn: 'Inghilswys', race: 'roegadyn', gender: 'F', job: 'lancer', img: 'RoegfInghilswys.jpg' },
        { id: 1016971, name: '菲爾萊絲·馮', nameEn: 'Fearless Fawn', race: 'roegadyn', gender: 'F', job: 'archer', img: 'Roegf_fearless.jpg' },
        { id: 1016972, name: '雷爾托塔', nameEn: 'Raelthota', race: 'roegadyn', gender: 'F', job: 'arcanist', img: 'RoegfRaelthota.jpg' },
        { id: 1016973, name: '瑞京·奧克斯', nameEn: 'Raging Ox', race: 'roegadyn', gender: 'M', job: 'arcanist', img: 'RoegmRaging.jpg' },
        // 敖龍族 Au Ra
        ...
        { id: 1016977, name: '薩姆嘉', nameEn: 'Samga', race: 'aura', gender: 'F', job: 'arcanist', img: 'Samga.jpg' },
